...
class VideoMessage(TypedMessage):
    def __init__(self, tracking_data=None, keyboard=None, media=None, thumbnail=None, 
                 size=None, text=None, duration=None, min_api_version=None):
    ...
    def __str__(self):
        return u"VideoMessage [{0}, media={1}, thumbnail={2}, size={3}, duration={4} text={5}]".format(
